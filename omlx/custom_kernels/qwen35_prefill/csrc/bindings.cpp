...
NB_MODULE(_ext, m) {
  ...
  m.def(
      ...
      "enabled"_a);
  m.def(
      "qwen35_ane_fence_set_enabled",
      &omlx::qwen35_prefill_kernels::qwen35_ane_fence_set_enabled,
      "enabled"_a);
  m.def(
      "qwen35_ane_fence_available",
      &omlx::qwen35_prefill_kernels::qwen35_ane_fence_available);
  m.def(
